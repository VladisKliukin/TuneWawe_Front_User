        ...
        <div className="w-[25%] h-full p-2 flex-col gap-2 text-white hidden lg:flex">
                    ...
                    {!showSearchInput ? (
                        ...
                        <div className="flex items-center gap-2 pl-4">
                            ...
                            <input type="text"
                                   ...
                                   autoFocus
                            />
                            <button className="p1 hover: bg-gray-700 rounded-full transition-colors">
            ...
            <div className="bg-[#121212] h-[85%] rounded">
                <div className="p-4 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                        <ArrowRight className="w-5 h-6 text-gray-400 hover:text-purple-400 transition-colors cursor-pointer "/>
                        <Plus className="w-6 h-6 text-gray-400 hover:text-purple-400 transition-colors cursor-pointer "/>
                    </div>
                </div>
                <div className="p-4 bg-[#242424] m-2 rounded font-semibold flex flex flex-col items-start justify-start gap-1 pl-4">
                    <h1>Create you first playlist</h1>
                    <p className="font-light">It`s easy we will help you</p>
                    <button className="px-4 py-1.5 bg-white text-[15px] text-black rounded-full mt-4 hover:bg-gray-300 transition-colors cursor-pointer">
                        Create playlist
                    </button>
                </div>
